...
(() => {
  ...
  add('easton-mode-v33.js?v=20260824-prealpha-v53-release','easton-mode-v33');
  ...
  add('victory-front-balance-v49.js?v=20260824-prealpha-v53','victory-front-balance-v49');
})();
