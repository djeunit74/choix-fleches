...
(() => {
  ...
  const steps=[
    {title:'Bienvenue dans Assistant Archer',text:'L’app propose des pistes pour vous aider à choisir vos flèches et à ajuster votre arc. Commencez par choisir votre type d’arc dans les paramètres.',tab:null},
