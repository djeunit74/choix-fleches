...
(() => {
  ...
  const upperTillerInput=document.getElementById("upperTiller"),lowerTillerInput=document.getElementById("lowerTillerMeasured");if(upperTillerInput){upperTillerInput.value="";upperTillerInput.placeholder="Ex : 222"}if(lowerTillerInput){lowerTillerInput.value="";lowerTillerInput.placeholder="Ex : 218"}
