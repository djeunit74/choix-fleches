...
(() => {
  ...
  function installAuditNotes() {
    ...
    addDetails('[data-panel="arc-setup"]','expertBaseAudit','1. Priorites de reglage',`
      <p><strong>Ordre conseille :</strong> commencer par le montage et les alignements mecaniques. Regler ensuite le tiller et le band, puis le point d encochage, le centrage/berger et enfin valider au tir.</p>
      <p>Si un probleme d alignement est visible, ne cherchez pas a le masquer avec le berger ou un autre reglage fin.</p>`,'#arcSetupResult');
    ...
    addDetails('[data-panel="arc-setup"]','alignmentGuidedCheck','2. Alignements et montage de base',`
      ...
      <p class="muted"><strong>Sources :</strong> World Archery, Coach's Manual Level 2, chapitre Recurve Bow Equipment Tuning ; Hoyt, manuels recurve et documentation de reglage des poignees. Les systemes d alignement varient selon les fabricants.</p>`,'#expertBaseAudit');
    ...
    addDetails('[data-panel="arc-setup"]','tillerGuidedTest','3. Tiller : reglage et test',`
      ...
      <p class="muted"><strong>Sources :</strong> World Archery, Coach's Manual Level 2, sections Recurve Bow Equipment Tuning et Barebow ; recommandations fabricant de votre poignee/branches.</p>`,'#alignmentGuidedCheck');
